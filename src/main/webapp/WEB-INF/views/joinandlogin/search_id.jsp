...
window.onload = function() {
      document.getElementById('submit').onclick = function() {
         ...
         if ( document.pfrm.email1.value.trim() == '' ) {
            alert( '메일을 입력해주세요' );
...
<div class="w3-content w3-container w3-margin-top">
      <div class="w3-container w3-card-4">
         <form action="${contextPath}/member/lookup_id.do" method="post" name="pfrm">
            ...
            <div>
               <p>
                  ...
                  <label>이메일</label>
                  <input class="w3-input" type="text" id="email1" name="email1" placeholder="이메일을 입력하세요" required>
               </p>
               <p class="w3-center">
