		...
		<table>
			<tbody>
				...
				<tr class="dot_line">
					...
					<td>
						<input type="text" name="member_rrn" size="20"> - <input type="text" name="" size="20">
					</td>
				</tr>
				<tr class="dot_line">
				...
				<tr class="dot_line">
					...
					<td><input size="10px"   type="text" name="email1" /> @ <input  size="10px"  type="text"name="email2" /> 
						<input type="button"  id="" value="이메일인증" onClick="" /><br><br>
						<input size="10px"   type="text" name="email_yn" />
						<input type="button"  id="" value="인증 번호 확인" onClick="" />
					</td>	
				</tr>
				<tr class="dot_line">
