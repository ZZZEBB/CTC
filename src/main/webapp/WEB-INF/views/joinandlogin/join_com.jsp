      ...
      <table>
         <tbody>
            ...
            <tr class="dot_line">
               ...
               <td>
               <input name="com_pw" type="password" size="20" /><br><br>
               <!-- 비밀번호 유효성검사 추가해야함 -->
               <!-- <input name="com_pw" type="password" size="20" placeholder="비밀번호확인" onfocus="this.placeholder=''" onblur="this.placeholder='비밀번호확인'" /> -->
               </td>
            </tr>
            <tr class="dot_line">
               <td class="fixed_join">사업자등록번호</td>
               <td> 
                  <input size="10px"  type="text" name="com_crn1"> - <input size="10px"  type="text" name="com_crn2"> - <input size="10px"  type="text"name="com_crn3">
                  
               </td>            
            </tr>
            <tr class="dot_line">
               <td class="fixed_join">상호명</td>
               <td><input name="com_name" type="text" size="20" /></td>
            </tr>
            <tr class="dot_line">
               <td class="fixed_join">대표자명</td>
               <td>
                  <input type="text" name="com_ceo" size="20">
               </td>
            </tr>
            <tr class="dot_line">
               <td class="fixed_join">사업체전화번호</td>
               <td> 
                  <input size="10px"  type="text" name="com_tel1"> - <input size="10px"  type="text" name="com_tel2"> - <input size="10px"  type="text"name="com_tel3">
               </td>            
            </tr>
           <tr class="dot_line">
    <td class="fixed_join">이메일<br>(e-mail)</td>
    <td>
        <input type="text" size="20px" name="com_email" id="com_email" placeholder="이메일">
