...
<link href="${contextPath}/resources/css/slider.css" rel="stylesheet" type="text/css">
...
<script type="text/javascript" src="${contextPath}/resources/jquery/slider2.js"></script>
	</div>		
</div>
	<!-- 카테고리별 숙박/렌터카 추천 -->
