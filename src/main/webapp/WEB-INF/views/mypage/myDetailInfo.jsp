...
<body>
   <h3 id="join_member">회원 수정 페이지</h3>
      ...
      <table>
         <tbody>
            <tr class="dot_line">
               ...
               <td>
                 <input type="text" name="member_id"  id="id" value="${memberInfo.member_id}" size="20" readonly="readonly"/>
               <br>
             ...
             <tr class="dot_line">
               ...
               <td>
                 <input type="password" id="member_pw" name="member_pw" minlength="8" maxlength="16" oninput="validatePassword()">
                 <br>
                 <span id="password-warn"></span>
                 <br>
                 <input type="password" id="password-confirm" name="password-confirm" placeholder="비밀번호 재입력" disabled minlength="8" maxlength="16" oninput="validatePasswordConfirm()">
                 <br>
            ...
            <tr class="dot_line">
              ...
              <td>
                <input name="member_name" id="member_name" value="${memberInfo.member_name}" readonly="readonly" type="text" size="20" oninput="validateName()">
                <br>
            ...
            <tr class="dot_line">
              ...
              <td>
                <input type="text" id="member_rrn1" name="member_rrn1" size="7" minlength="6" maxlength="6" oninput="validateRRN()">
                -
                <input type="password" id="member_rrn2" name="member_rrn2" size="7" minlength="7" maxlength="7" oninput="validateRRN()">
                <br>
            ...
            <tr class="dot_line">
               ...
               <td> 
                  <input size="10px"  type="text" name="member_ph1" minlength="3" maxlength="3" oninput=validatePh()  > - 
                  <input size="10px"  type="text" name="member_ph2" minlength="4" maxlength="4" oninput=validatePh()  > - 
                  <input size="10px"  type="text"name="member_ph3" minlength="4" maxlength="4" oninput=validatePh()  >
                  <br>
            ...
            <tr class="dot_line">
                ...
                <td>
                    <input type="text" size="20px" name="member_email" id="member_email" placeholder="xxx@xxx.xxx 형식"/>
                    <br>
