...
public class CartControllerImpl implements CartController {
	...
	public @ResponseBody String addGoodsInCart(@RequestParam("goods_code") String goods_code/* 전송된 상품코드를 받습니다 */, HttpServletRequest request, HttpServletResponse response)  throws Exception{
		HttpSession session=request.getSession();
